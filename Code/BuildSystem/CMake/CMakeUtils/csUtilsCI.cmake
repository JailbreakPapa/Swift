# #####################################
# ## CS_ci_add_to_targets_list(<target> [C++])
# #####################################

function(CS_ci_add_to_targets_list TARGET_NAME LANGUAGE)
...
# #####################################
# ## CS_ci_add_test(<target> [NEEDS_HW_ACCESS])
# #####################################
function(CS_ci_add_test TARGET_NAME)
	...
	if(ARG_UNPARSED_ARGUMENTS)
		message(FATAL_ERROR "CS_ci_add_test: Invalid arguments '${ARG_UNPARSED_ARGUMENTS}'")
	endif()
