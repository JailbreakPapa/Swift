# #####################################
# ## CS_list_subdirs(result curdir)
# #####################################

macro(CS_list_subdirs result curdir)
...
# #####################################
# ## CS_android_add_default_content(<target>)
# #####################################
function(CS_android_add_default_content TARGET_NAME)
	CS_pull_all_vars()

	if(NOT CS_CMAKE_PLATFORM_ANDROID)
		return()
	endif()
	...
	set(CONTENT_DIRECTORY_SRC "${CMAKE_SOURCE_DIR}/${CS_SUBMODULE_PREFIX_PATH}/Data/Platform/Android")
	...
	CS_list_subdirs(AVAILABLE_BUILD_TOOLS ${ANDROID_BUILD_TOOLS_ROOT})
