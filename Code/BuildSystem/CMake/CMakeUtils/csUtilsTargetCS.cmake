# #####################################
# ## CS_create_target_CS(<LIBRARY | APPLICATION> <target-name>)
# #####################################

macro(CS_create_target_CS TYPE TARGET_NAME)
	CS_apply_build_filter(${TARGET_NAME})

	set(ARG_OPTIONS NO_CS_PREFIX)
	...
	if(ARG_UNPARSED_ARGUMENTS)
		message(FATAL_ERROR "CS_create_target_CS: Invalid arguments '${ARG_UNPARSED_ARGUMENTS}'")
	endif()
	...
	elseif(${TYPE} STREQUAL "APPLICATION")
		...
		message(FATAL_ERROR "CS_create_target_CS: Missing argument to specify target type. Pass in 'APPLICATION' or 'SHARED_LIBRARY' or 'STATIC_LIBRARY'.")
	endif()
	...
	# use CS_make_winmain_executable if this is desired
