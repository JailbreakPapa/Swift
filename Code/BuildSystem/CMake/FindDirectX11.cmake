...
if(CS_CMAKE_PLATFORM_WINDOWS) # The only platform it makes sense to check for DirectX11 SDK
	...
	set(DirectX11_INC_SEARCH_PATH
		"C:/Program Files (x86)/Windows Kits/10/Include/${CS_CMAKE_WINDOWS_SDK_VERSION}/shared"
		"C:/Program Files (x86)/Windows Kits/10/Include/${CS_CMAKE_WINDOWS_SDK_VERSION}/um"
	...
	set(DirectX11_LIB_SEARCH_PATH
		"C:/Program Files (x86)/Windows Kits/10/Lib/${CS_CMAKE_WINDOWS_SDK_VERSION}/um"
	...
	mark_as_advanced(DirectX11_INCLUDE_DIR
		...
		DirectX11_DXGI_LIBRARY
		DirectX11_D3DCOMPILER_LIBRARY)
endif(CS_CMAKE_PLATFORM_WINDOWS)