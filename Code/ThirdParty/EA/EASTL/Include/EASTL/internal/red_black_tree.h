...
#ifndef EASTL_RED_BLACK_TRFS_H
#define EASTL_RED_BLACK_TRFS_H
...
namespace eastl
{
	...
	/// EASTL_RBTRFS_DEFAULT_NAME
	///
	/// Defines a default container name in the absence of a user-provided name.
	///
	#ifndef EASTL_RBTRFS_DEFAULT_NAME
		#define EASTL_RBTRFS_DEFAULT_NAME EASTL_DEFAULT_NAME_PREFIX " rbtree" // Unless the user overrides something, this is "EASTL rbtree".
	#endif


	/// EASTL_RBTRFS_DEFAULT_ALLOCATOR
	///
	#ifndef EASTL_RBTRFS_DEFAULT_ALLOCATOR
		#define EASTL_RBTRFS_DEFAULT_ALLOCATOR allocator_type(EASTL_RBTRFS_DEFAULT_NAME)
	#endif


	/// EASTL_RBTRFS_LEGACY_SWAP_BEHAVIOUR_REQUIRES_COPY_CTOR
	///
	#ifndef EASTL_RBTRFS_LEGACY_SWAP_BEHAVIOUR_REQUIRES_COPY_CTOR
		#define EASTL_RBTRFS_LEGACY_SWAP_BEHAVIOUR_REQUIRES_COPY_CTOR 0
	#endif
	...
	public:
		...
		rbtree(const Compare& compare, const allocator_type& allocator = EASTL_RBTRFS_DEFAULT_ALLOCATOR);
		rbtree(const this_type& x);
		rbtree(this_type&& x);
		rbtree(this_type&& x, const allocator_type& allocator);

		template <typename InputIterator>
		rbtree(InputIterator first, InputIterator last, const Compare& compare, const allocator_type& allocator = EASTL_RBTRFS_DEFAULT_ALLOCATOR);
	...
	inline rbtree<K, V, C, A, E, bM, bU>::rbtree()
		: mAnchor(),
		  mnSize(0),
		  mAllocator(EASTL_RBTRFS_DEFAULT_NAME)
	{
		reset_lose_memory();
	}
	...
	{
	#if EASTL_RBTRFS_LEGACY_SWAP_BEHAVIOUR_REQUIRES_COPY_CTOR
